    ...
    <div class="bg-white shadow-lg rounded-lg md:max-w-4xl w-full overflow-hidden" id="invoiceContent">
            ...
            <div class="bg-gray-800 text-white p-3">
                <div class="flex max-md:flex-col justify-between items-center max-md:text-center gap-6">
                    <div class="flex items-center max-md:flex-col">
                        <img src="assets/images/logo/logo.png" alt="" class="w-20 h-20">
                        <div>
                            <p class="text-2xl font-bold uppercase text-white">Udarata Computers</p>
            ...
            <div class="p-3 border-t">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-justify">Thank you for your business. Please make payment by the due date. For any queries regarding this invoice, please contact our support team at support@udaratacomputers.com or call +94 (77) 987-6543.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-gray-800 text-white text-right text-sm flex justify-between max-sm:flex-col max-sm:items-center gap-3">
                <ul class="w-fit flex gap-6 items-end">
                    ...
                    <li><a href="https://www.tiktok.com/@udaratacomputers" class="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16"><path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/></svg></a></li>
                </ul>
