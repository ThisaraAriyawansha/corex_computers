...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            <p>Dear {{ $username }},</p>
            <p>Thank you for registering with <span class="highlight">Udarata Computers</span>! We're thrilled to have you as part of our growing community. Our team is here to help you make the most out of your experience.</p>
